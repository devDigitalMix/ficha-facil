# Fase 19 — as 391 magias, uma por uma

Feita em 2026-09-03. A releitura completa das paráfrases de magia contra o texto do
capítulo 7, magia por magia, lendo os dois lado a lado.

`testes/rodar_todos.py`: **16 de 16 passos limpos.** Motor em 70 de 70, `validar.py` com
0 erros e 0 avisos, `checar_schema.py` 76/76, dez testes negativos e `reconstruir.py
--comparar` em 67/67 sem diferença de conteúdo.
...
Passo 5 do plano: o **backend**, com os endpoints da §7.
